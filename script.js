document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeGameVariables() {
        ...
        playerState.inventory = { "🎥": 0, "☕": 2, "👽": 0, "📃": 0, "⚫": 0, "🎁": 0 }; // Removed tool items
        ...
        activeEffects.cosmicUpgradePenaltyActive = false; // Tracks if the upgrade has been purchased
        activeEffects.quantumUpgradePenaltyActive = false; // Tracks if the upgrade has been purchased
    ...
    function initGame() {
        ...
        DOM_ELEMENTS.luckyBtn.innerHTML = 'Lucky';
