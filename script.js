document.addEventListener('DOMContentLoaded', () => {
    ...
    function spin() {
        ...
        // MODIFICATION: Adjust timing for the new reelSpin animation
        const animationDuration = 500; // Corresponds to the reelSpin animation duration
        const baseDelayPerCell = 60; // Slightly increased for a better cascading effect
    ...
    function updateGridDOM(gridSymbols, currentMultiplier, animate = false) {
        ...
        const baseDelayPerCell = 60; // Adjusted for new animation
        ...
        gridSymbols.forEach((item, index) => {
            ...
            if (animate) {
                // MODIFICATION: Use new reelSpin animation class
                div.classList.add('anim-reelSpin');
